...
This is a full guide on how to get into a **prestigious, well-paid, international company** from UTCN (or any romanian college for that matter). The term FAANG originated from big tech giants, but is now more of an umbrella term for prestigious companies. 
...
## Why Faang?
Why should you choose a FAANG company ? Perhaps you have a lovely environment back home you don't want to give up. And that's fine. But you should at least know what other opportunities are out there both for your information and potential change in the future. 
With that being said, here are the main Pros & Cons we see.
### Pros 
  - **High salaries**: In general, salaries at FAANG companies are bigger than at any local companies, no matter the location.   Salaries before taxes can be [on this website](https://www.levels.fyi/leaderboard/Software-Engineer/Entry-Level-Engineer/country/Romania/), which are accurate in our experience. At FAANG you will also receive a part of your TC (total compensation) in stocks, which are taxed lower than normal salary. We will split the discussion into western and eastern salaries for internships, software engineers and managerial positions. Our examples are from Microsoft and Google, but this holds for many big companies. Some, like hedge funds, go much higher than this.
    - *Internships*: In Romania, Poland, etc, you will get about 2000 euro / month **after taxes** + relocation bonus which amounts to about 3000-4000 euro. If you find cheap or free rent, you can keep all of it no questions asked. For western high-paying cities such as London and Zurich, you may reach up to 8000 euro / month **before** taxes, which translates, depending on the country, to about 5000-6000 euro / month after taxes. Relocation bonus is also higher, reaching 5000-8000 euro for the duration of the internship. 
    - *Software engineers*: In the east, you start with about 5000-6000 euro / month **before taxes**, meaning about 3500 euro / month after taxes at **entry level**. At senior, level you get about twice as much. In the west, you can expect around 10k-15k euro / month before taxes at entry level, reaching up to 30k euro / month at senior level. 
    - *Managerial positions*: To get here you will have to put in the effort and surpass senior level. These guys coordinate small or large teams and reach up to 100k euro / month before taxes, which amounts to about 1.2M / year. Not everyone will get here, but if you are looking for the *safe* route to millions, this is probably it. 
  - **No bullshit culture**: You are much less likely to find the "year of experience" criteria and can become a senior or even a manager in 2-3 years, perhaps even faster, if you are good enough. Most people are able to become seniors in about 4 years, without having extreme technical feats of destroying their lives in the process.
  - **Potential for Startups / Opportunities / Exits**: There is an infamous metric called tenure (how much an engineer stays employed on average), [which for FAANG is about 2-3 years](https://www.businessinsider.com/average-employee-tenure-retention-at-top-tech-companies-2018-4 ). Most people who work at FAANG benefit from several opportunities attached to the prestige. For the most part, being considered the top 1% (even if you aren't) will allow you to get interviews easily almost everywhere and obtain higher salary, as well as easier access to VC funding if you want to make a startup. Considering the fact that after 3 years you will have between 100k-500k euro saved up (unless you are a really big spender), puts you in a good position in terms of money, knowledge, people and expectations. Or perhaps, [you are into goose farming](https://www.linkedin.com/in/dryuan/?trk=public_post_embed_feed-actor-name), whatever makes you fulfilled.
  - **Unique knowledge and high quality network** :There are certain phenomenas both in [nature and software](https://en.wikipedia.org/wiki/Emergence) which appear only at large scales. The knowledge required to handle such systems is very rare, given that there are not so many BIG softwares in the world and most of them are owned by FAANG companies. The infrastructure you will see there is unique and will give you a much broader perspective into building projects as a whole. Additionally, the people there will have the same know-how as you do now and the same advantages as you. This tends to make employees of FAANG companies to band together for future projects and helping each other out in the industry. Furthermore, FAANG is where the money is, so having a successful startup exit, creating a consulting company or whatever high money activity you want to run (legally) will be much easier given the connections and high expectations.
  - **Possibility to move abroad**: Being international companies, you can request team changes and moving abroad, which can be quite useful in the case of both internal and external threats for your country.

Of course, life is not perfect and neither is FAANG, so below are the main cons of working at a FAANG company.
### Cons
  - **Stupid hiring criteria / High initial investment**: A college student from the US has recently made 22 million dollars in about 40 days by selling a tool called [Interview coder](https://www.interviewcoder.co), with a slogan we are not going to name. It is an overlay over your browser which used during interviews which sends questions to chatgpt and displays responses. The student made a demo by getting internships at Amazon and Citadel and then got kicked out of school. Most big tech companies are currently employing leetcode style of interviews, which in a sense is an advantage, allowing you to have some predictability. But in most other ways, it's a really bad way of evaluating a candidate and will miss many of their actual skills (or lack thereof). Until this trend changes, you will have to know you algorithms and data structures right and do lots of leetcode problems, which can be a really wasteful use of your time and tends to turn into a large memorization + interpolation of algorithms, without testing any adaptability, capacity of understanding or passion. For example, the creator of homebrew, a software which most of Google employees use, [was rejected by Google for not being able to invert a binary tree](https://news.ycombinator.com/item?id=34288766).
  - **Work-life balance**: This one depends both on you and the company but **With lots of power, comes lots of responsability**. Being in one of the big tech companies will require you to be a high performer and do your job WELL. Despite this, some companies such as Microsoft and Netflix allow full remote work, with Netflix not even mandating any work our, just a "do your job" policy. On the other hand Amazon is known for grinding their employees down and mandating them to go to the office 5 days a week. Another example if Nvidia, which would rather [torture you to greatness](https://fortune.com/2024/09/05/nvidia-ceo-jensen-huang-torture-employees-to-greatness-culture/) than fire you. However, if you are the kind to want more from your life and want to put the work in it, these kinds of environments might be beneficial if they reward you properly, which some do and some don't. 
  - **Layoffs**: Tied to work-life balance section, there have been lots of layoffs after Covid, and it seems that even if this trend has faded, it is still always lurking in the shadows. Just recently, Meta started putting "firing targets", aiming to layoff ["low performing employees"](https://www.theguardian.com/technology/2025/jan/15/meta-to-fire-thousands-of-staff-mark-zuckerberg-warns-of-intense-year), which is a trend that might accelerate with the whole AI wave, justified or not.
  - **Limited scope**: Again, this one depends on your purpose, but working on large systems will have you occupy an extremely tiny space and not seeing the overview and understanding why things are as they are. This contradicts with the Unique knowledge section, and there is some duality to it. In small companies / startups you can expect to be involved in many operations and develop your skills quite aggresively while in big companies, you are expected to work on really narrow parts of an already existing project. This is not specific to FAANG, more like tha natural lifecycle of any company which needs to maintain some product, but you should be aware of it nonetheless. However, most big tech companies allow their employees to move between projects or even do internal career changes, so this con can be avoided or diminished.
  - **No ownership**: Not really specific to big tech but the industry as a whole. If you do outstanding work, there is a good chance you will get nothing other than a bonus out of it. However, this can be mitigated by paving the way to a startup by working at a FAANG company as mentioned above.
### Mixed
